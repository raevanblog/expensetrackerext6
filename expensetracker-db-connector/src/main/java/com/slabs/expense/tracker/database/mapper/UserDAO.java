...
public interface UserDAO {
	...
	public Integer insertUserFeature(@Param("record") UserFeature feature) throws Exception;

	public Integer updateUserFeature(@Param("record") UserFeature feature) throws Exception;

	public Integer deleteUserFeature(@Param("username") String username) throws Exception;

	public UserFeature getUserFeature(@Param("username") String username) throws Exception;
