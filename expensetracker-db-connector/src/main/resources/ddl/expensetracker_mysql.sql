...
CREATE TABLE EXPENSETRACKER.USER_SETTINGS (
	...
	CONSTRAINT fk_settings_currency FOREIGN KEY(CURRENCY) EXPENSETRACKER.CURRENCY(ID)
);
...
CREATE TABLE EXPENSETRACKER.INVENTORY (
	...
	CONSTRAINT fk_inventory_expid FOREIGN KEY(EXPID) REFERENCES EXPENSETRACKER.EXPENSE(ID)
);
