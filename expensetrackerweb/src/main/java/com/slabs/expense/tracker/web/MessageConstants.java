...
public class MessageConstants {
	...
	public static final String ACCOUNT_LOCKED = "Your account is locked by the administrator, please contact customer support.";
	...
	public static final String LOGD_OFF = "Logged Off.";
